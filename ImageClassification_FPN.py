...
############################################################################################
pickle_in = open("XCD_train.pickle","rb") # Load the training dataset 
X = pickle.load(pickle_in)
print(X.shape)

pickle_in = open("yCD_train.pickle","rb") # Load the training labels 
...
# Load ResNet50V2, MobileNetV2, InceptionV3 ... ImageNet pre-trained weights
...
base_model = tf.keras.applications.ResNet101(weights=None, alpha=1, include_top=False, input_shape=tuple(X.shape[1:]))
...
# To create CSV file to store model results
